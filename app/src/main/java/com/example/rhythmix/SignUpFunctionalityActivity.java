    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyButton.setOnClickListener(view -> {
            ...
            if (verificationCode.isEmpty()) {
                Toast.makeText(SignUpFunctionalityActivity.this, "Please enter a verification code", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            Amplify.Auth.confirmSignUp(username,
                    ...
                    failure -> {
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(SignUpFunctionalityActivity.this, "Verify account failed!!", Toast.LENGTH_LONG).show();
                        });
                    }
            );
        });
        ...
        signupSubmitButton.setOnClickListener(v -> {
            ...
            Amplify.Auth.signUp(username,
                    ...
                    bad -> {
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(SignUpFunctionalityActivity.this, "Signup failed", Toast.LENGTH_LONG).show();
                        });
                    }
            );
        });
        ...
        Amplify.Auth.fetchUserAttributes(
                attributes -> {
                    ...
                    if (!userEmail.isEmpty()) {
                        ...
                        Intent goToProfileIntent = new Intent(SignUpFunctionalityActivity.this, ProfileFunctionalityActivity.class);
                        goToProfileIntent.putExtra(ProfileFunctionalityActivity.USER_EMAIL_EXTRA, userEmail);
