...
public class ChoosePlaylistActivity extends AppCompatActivity implements ChoosePlaylistAdapter.OnPlaylistClickListener{
    ...
    public void addToPlaylistAndAmplify(Track selectedTrack) {
        ...
        com.amplifyframework.datastore.generated.model.Music music = com.amplifyframework.datastore.generated.model.Music.builder()
    ...
    private void saveMusicItem(com.amplifyframework.datastore.generated.model.Music music) {
        Amplify.API.mutate(
